...
A utility to convert Aseprite files to various ZX Spectrum Next formats including sprites, fonts, maps, and Layer 2 graphics. This tool is a more generic evolution from the one specifically designed for development of [Next Point](https://github.com/vmorilla/next-point).
